            ...
            html.Div([
                ...
                html.Div([
                    ...
                    html.Div(id='leaderboards-container', style={'display': 'flex', 'gap': '20px'}, children=[
                        ...
                        html.Div(id="golden-boot-panel", style={'flex': 1, **card_style}, children=[
                        ...
                        # Panel for Red Cards
                        html.Div(id="red-card-panel", style={'flex': 1, **card_style}, children=[
                            html.H3("Red Card Leaders", style=plot_title_style),
                            html.Div(id="red-card-tracker") # Content will be generated by callback
                        ]),
                    ])
                ...
                # --- Right Column ---
                 html.Div([
                    ...
                    # Card for team journey, player stats, and H2H
                    html.Div(id="team-player-detail-panel", children=[
                        ...
                        html.Hr(id='h2h-separator', style={'display': 'none'}),
                        html.Div(id='h2h-section', style={'display': 'none'}, children=[
                            html.H4("Head-to-Head Analysis", style={"marginTop": "20px", "color": "#1a5276"}),
